...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
      <a href="{{ url('/pengadaan') }}" class="btn btn-secondary">Kembali</a>
    </div>
  </div>
  ...
  <div class="card mb-3 shadow-sm">
    <div class="card-body">
      <div class="row">
        <div class="col-md-4"><strong>Vendor:</strong> {{ $header->nama_vendor }}</div>
        <div class="col-md-4"><strong>Tanggal:</strong> {{ date('Y-m-d H:i', strtotime($header->timestamp)) }}</div>
